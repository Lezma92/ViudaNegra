                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    <div class="card border-primary m-1">
                        <div class="card-header text-center">
                            <h5>
                                <p>Historial de General de ordenes</p>
                            </h5>
                            <?php echo ("<p class='text-primary'>Hola <strong class='text-danger'>" . $_SESSION['usuario'] . "</strong> en esté apartado se muentran todos los pedidos se han atendido.</p>"); ?>
                        ...
                        <div class="card-body pad table-responsive">
                            ...
                            <table class="table table-bordered  table-hover " id="tablaHistorial">
                                ...
                                <tbody>
                                    ...
                                    $Historial =  ControladorOrdenes::verHistorialDiario();
